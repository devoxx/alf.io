...
public class TicketReservationManagerIntegrationTest {
    ...
    public void testTicketWithDiscount() {
        ...
        eventManager.addPromoCode("MYPROMOCODE", event.getId(), null, event.getBegin(), event.getEnd(), 10, PromoCodeDiscount.DiscountType.PERCENTAGE, null, null, "description", "email@reference.ch");
