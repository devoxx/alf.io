...
public interface EventRepository {
    ...
    @Query("select coalesce(sum(src_price_cts - discount_cts),0) from ticket where event_id = :eventId and status in("+TicketRepository.CONFIRMED+")")
    long getNetIncome(@Bind("eventId") int eventId);
